<template>
    <div class="header flex justify-between items-center p-4 bg-background text-primary gap-2 sticky top-0">
        ...
        <nav class="flex-1 flex justify-center gap-4">
            ...
            <NuxtLink to="/map" class="hover:underline">Autour de moi</NuxtLink>
        </nav>
        <div class="user-info">
