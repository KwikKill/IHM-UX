<template>
  ...
  >
    <div class="w-[92vw] md:w-[70vw] grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <Card class="w-full p-8 rounded-lg shadow-md">
        ...
        <div class="mt-6">
          ...
          >
            <div>
              <label for="current" class="block text-sm font-medium">
                Mot de passe actuel
              </label>
              <input
                id="current"
            ...
            <div>
              <label for="newpass" class="block text-sm font-medium">
